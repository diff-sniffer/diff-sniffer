...
```
$ wget https://github.com/diff-sniffer/git/releases/download/3.5.0/pre-commit.phar
...
```
$ wget https://github.com/diff-sniffer/git/releases/download/3.5.0/git-phpcs.phar
