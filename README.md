...
```
$ wget https://github.com/diff-sniffer/git/releases/download/0.3.1/pre-commit.phar
...
```
$ wget https://github.com/diff-sniffer/git/releases/download/0.3.1/git-phpcs.phar
